...
- At the start of every task in this repository, read and apply all files under `.agent/rules/` before doing any substantive work.
- Treat `.agent/rules/` as persistent repo-level operating rules for future sessions and future conversations in this project.
- If a rule in `.agent/rules/` conflicts with a user request, ask for confirmation before proceeding unless the user has already been explicit.
...
- Keep technical keywords/code identifiers in English.
